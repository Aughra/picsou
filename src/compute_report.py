############################################################
# CHANGELOG:
# - [2025-09-21] agt011 {author=agent} {reason: placeholder compute_report pour pipeline}
# - Impact: évite l’échec de run.sh si le rapport n’est pas encore implémenté
# - Tests: exécution run.sh; ce module log puis sort
# - Notes: à remplacer par le compute réel si nécessaire
############################################################
"""Compute du rapport (placeholder).

Ce module est un stub pour permettre à la pipeline de s'exécuter.
Il ne calcule pas encore de rapport.
"""
...
def main() -> None:
    logger.info("compute_report: placeholder — pas de calcul effectué.")
