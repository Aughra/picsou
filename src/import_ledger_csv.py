############################################################
# CHANGELOG:
# - [2025-09-21] agt010 {author=agent} {reason: placeholder import_ledger_csv pour pipeline}
# - Impact: évite l’échec de run.sh si l’import n’est pas encore implémenté
# - Tests: exécution run.sh; ce module log puis sort
# - Notes: à remplacer par l’import réel si nécessaire
############################################################
"""Import des transactions (placeholder).

Ce module est un stub pour permettre à la pipeline de s'exécuter.
Il ne réalise pas d'import, mais s'arrête proprement.
"""
...
def main() -> None:
    logger.info("import_ledger_csv: placeholder — rien à importer.")
